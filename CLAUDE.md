...
Soy estudiante de Ecologia de profesion geografo. No tengo experiencia previa en
...
además de estadístico. Y usa ejemplos para explicar los resultados
...
Estamos en el curso para aprender a usar claude code -->
